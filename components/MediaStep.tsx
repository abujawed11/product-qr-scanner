...
//             <Text style={{ color: "#FAD90E", fontWeight: "bold", fontSize: 18 }}>{step.title}</Text>
...
//             <Text style={{ color: "#FAD90E", fontWeight: "bold" }}>Upload Image</Text>
...
//                     >
//                         <Text style={{ color: "#FFF", textAlign: "center", fontWeight: "bold" }}>Delete Image</Text>
//                     </TouchableOpacity>
//                 </View>
//             ) : (
...
//                     >
//                         <Text style={{ color: "#FFF", textAlign: "center", fontWeight: "bold" }}>Delete Video</Text>
//                     </TouchableOpacity>
//                 </View>
//             ) : (
//                 <View style={{ flexDirection: "row", marginBottom: 16 }}>
...
//                 </TouchableOpacity>
//                 <TouchableOpacity onPress={goNext} style={{ padding: 12, borderRadius: 8, backgroundColor: "#FAD90E" }}>
...
//             //     paddingTop: 12,
//             //     paddingBottom: 16, // This, plus SafeArea, keeps buttons above nav bar!
//             //     backgroundColor: "#000",
//             //     borderTopWidth: 1,
//             //     borderTopColor: "#222"
//             // }}
