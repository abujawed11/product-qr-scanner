// // components/ChecklistStep.tsx
// import { checklistItems } from "@/app/(main)/warranty/claim-steps"; // adjust path as needed
...
//             <Text style={{ color: "#FAD90E", fontWeight: "bold", fontSize: 22, marginBottom: 18, textAlign: "center" }}>
