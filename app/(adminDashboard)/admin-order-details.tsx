...
//     return (
//         <ScrollView className="flex-1 bg-[#18181A] px-4 py-6">
//             {/* Header */}
...
//                 ) : (
//                     kits.map((item) => (
//                         <View key={item.kit.kit_id} className="flex-row items-center mb-2 p-3 bg-[#191A1D] rounded-lg">
...
//                             <TouchableOpacity
//                                 onPress={() => {
//                                     // Link to Kit detail page if needed
//                                 }}
//                                 className="bg-[#FAD90E] py-1 px-4 rounded-xl ml-2"
//                             >
//                                 <Text className="text-[#0F1112] font-bold text-sm">View</Text>
//                             </TouchableOpacity>
//                         </View>
//                     ))
//                 )}
...
//                 <Text className="text-sm text-[#F5F5F5] mb-2">{order.delivery_address || "N/A"}</Text>
...
//                 </Text>
//                 <Text className="text-xs text-[#BFBFBF]">
//                     Payment %: <Text className="text-[#F5F5F5]">{order.payment_percentage || "N/A"}</Text>
//                 </Text>
//             </View>

//             {/* Docs and Lots Buttons */}
//             <View className="mb-4 flex-row flex-wrap justify-around">
//                 <TouchableOpacity
//                     onPress={() => {/* navigate to QC Docs */ }}
//                     className="bg-[#007aff] rounded-lg px-6 py-2 mx-2 mb-2"
//                 >
//                     <Text className="text-white font-bold">QC Docs</Text>
//                 </TouchableOpacity>
//                 <TouchableOpacity
//                     onPress={() => {/* navigate to Dispatch Docs */ }}
//                     className="bg-[#7c3aed] rounded-lg px-6 py-2 mx-2 mb-2"
//                 >
//                     <Text className="text-white font-bold">Dispatch Docs</Text>
//                 </TouchableOpacity>
//                 <TouchableOpacity
//                     onPress={() => {/* navigate to Dispatch Lots */ }}
//                     className="bg-[#10b981] rounded-lg px-6 py-2 mx-2 mb-2"
//                 >
